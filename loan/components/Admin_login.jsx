...
const Admin_Login = ({ axios }) => {
    const { login_api, setAPIloading } = useStateContext();
    ...
    const handle_submit = (e) => {
        ...
        if (Object.values(errors).every((error) => !error)) {
            ...
            login_api(axios, other, setAPIloading);
        }
    }
    return (
                    ...
                    <div className='flex-1 flex flex-col md:justify-center items-center  bg-slate-100 mt-[50px] md:mt-0'>
                        ...
                        <form onSubmit={handle_submit} className='flex flex-col gap-8 px-[20px] h-fit' >
                            <div className='flex flex-col w-full gap-1 justify-center' >
                                ...
                                <p className='text-[13px] md:text-[15px] font-semibold text-slate-500' >Loan App admin page, please login to access the app</p>
                            </div>
